    ...
    <v-container>
        ...
        <v-row>
            <v-col cols="12" sm="12" md="4">
                <div class="item-title">包装について</div>
            </v-col>
            <v-col cols="12" sm="12" md="8">
                <div class="mb-8">
                    <p class="description">
                        aya & co.では、商品のご注文時に、以下の２つのオプションから配送方法をお選びいただけるようになりました。
                    </p>
                    <p class="description">
                        ・ゆうパック（日本郵便）<br>
                        ・宅急便コンパクト（ゆうパック）
                ...
                <div class="mb-8">
                    ...
                    <p class="description">
                        ゆうパックでは、宅配50サイズ（長さ201mm × 幅167mm × 深さ102mm）の箱のなかに、木毛の緩衝材を用いて商品を配置します。さらに、葉書サイズの「選べるメッセージカード」を同封します。
                    </p>
                    <p class="description">
                ...
                <div class="mb-8">
                    ...
                    <p class="description">
                        また、葉書サイズのメッセージカードは瓶に押されて折り目がついてしまうため、「選べるメッセージカード」はご利用いただけません。
                    </p>
                    <p class="description">
                        宅急便コンパクトは、ご自宅用にお買い求めいただく際に適した配送方法です。ゆうパックと比較して、審美的にはやや劣りますが、aya & co.では大変リーズナブルな送料を提供させていただいております。
                    </p>
                </div>
