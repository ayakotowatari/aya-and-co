        ...
        <v-row justify="center">
            <v-col cols="12" sm="12" md="6">
                 <v-form 
                    ...
                    lazy-validation
                >
                    <div v-if="cartQuantity <= 3  && setQuantity <= 0" class="mb-8">
                     ...
                     <div v-if="cartQuantity >= 4" class="mb-8">
                        <div class="jp-font grey--text text--darken-3 mb24">Step 1: ご希望の配送方法をお選びください。</div>
                        <div class="jp-font grey--text text--darken-2 mb24">ご用途に応じた配送方法の選び方については、<router-link to="/postage">こちら</router-link>でご案内しております。</div>
                     ...
                     <div v-if="cartQuantity <=2 && setQuantity >= 2" class="mb-8">
                        <div class="jp-font grey--text text--darken-3 mb24">Step 1: ご希望の配送方法をお選びください。</div>
                        <div class="jp-font grey--text text--darken-2 mb24">ご用途に応じた配送方法の選び方については、<router-link to="/postage">こちら</router-link>でご案内しております。</div>
                    ...
                    <div v-if="cartQuantity >= 3 && setQuantity >=1" class="mb-8">
                        <div class="jp-font grey--text text--darken-3 mb24">Step 1: ご希望の配送方法をお選びください。</div>
                        <div class="jp-font grey--text text--darken-2 mb24">ご用途に応じた配送方法の選び方については、<router-link to="/postage">こちら</router-link>でご案内しております。</div>
                    ...
                    <div v-if="this.courier == 2 && cartQuantity > 3">
