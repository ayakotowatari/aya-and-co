<template>
    <div class="mb-8">
        ...
        <div class="item-content policy-title mb-4">
            1梱包(ゆうパック)でお送りできる商品数
        </div>
        <p class="description">
            セット商品：　1セットまで<br>
            単品：　100g瓶・140g瓶、あわせて3つまで
        </p>
        <p class="description mb-8">
        ...
        <p class="description">
            会員登録されているお客様で、ゆうパックをご利用になりご自宅で商品を受け取られてから、どなたかにギフトとして手渡しされたい場合には、ご注文時に備考欄へその旨をご記入ください。梱包後に、さらに別の箱に梱包して、お送りします。
        </p>
    </div>
</template>
